const authorize = () => {
    ...
    return `http://localhost:8765/authorization-server/oauth2/authorize?client_id=client&redirect_uri=http://127.0.0.1:3000/authorized&scope=openid&response_type=code&response_mode=query&code_challenge_method=S256&code_challenge=${code_challenge}&state=c3cn0u3ee2f&nonce=r13xjtjz3yo`;
}
